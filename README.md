...
O projeto **Lobo-guará Tech** busca solucionar a lacuna de transformar ações sustentáveis, em um sistema de recompensa e desafios, com rankeamento, atingindo o usuário e seu ciclo de engajamento, pensando em seus objetivos e motivações. Indo de encontro com a junção das **inovações incremental e disruptiva**, conectando mecanismos já existentes com as lacunas presentes na sustentabilidade. Criamos, assim, um **Sistema de Gamificação Sustentável** integrado à plataforma, com rankeamento, desenvolvido para transformar ações sustentáveis em recompensas tangíveis, relacionado diretamente à lacuna de transformar ações sustentáveis, em um sistema de recompensa e desafios, com rankeamento, atingindo o usuário e seu ciclo de engajamento, pensando em seus objetivos e motivações.
...
* **JavaScript:** Manipulação dinâmica do DOM para o funcionamento interativo do sistema de **Accordion** na página de FAQ (perguntas frequentes), gerenciando estados de expansão de texto e controle de `max-height`.
...
![Demonstração da Home Page](img/print-home.png)  
*Legenda: Seção Info principal projetada com contraste refinado, tipografia focada na legibilidade e foco na conversão imediata do usuário para conhecer o projeto.*

### 📄 2. Página Institucional (`sobre.html`)
![Demonstração da Página Sobre](img/print-sobre.png)  
...
![Demonstração da Página de Solução](img/print-solucao.png)  
...
![Demonstração do FAQ Responsivo](img/print-faq.png)  
...
![Demonstração da Página de Integrantes](img/print-integrantes.png)  
...
![Demonstração da Página de Contato](img/print-contato.png)  
